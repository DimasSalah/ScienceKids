...
class _HomePageState extends State<AtomPage> {
  @override
      ...
      body: Container(
        decoration: BoxDecoration(
            gradient: LinearGradient(
                colors: [gradientStartColor2, gradientEndColor],
                    ...
                    return InkWell(
                      ...
                      child: Stack(
                        children: <Widget>[
                          ...
                          Hero(
                            tag: atoms[index].position,
                            child: Image.asset(atoms[index].iconImage),
                          ),
                          Positioned(
                            right: 24,
                            bottom: 60,
                            child: Text(
                              atoms[index].position.toString(),
                              style: TextStyle(
                                fontFamily: 'Avenir',
                                fontSize: 200,
