...
class LogamPage extends StatefulWidget {
  @override
  _HomePageState createState() => _HomePageState();
}

class _HomePageState extends State<LogamPage> {
  @override
                    ...
                    return InkWell(
                      onTap: () {
                        Navigator.push(
                          context,
                          PageRouteBuilder(
                            pageBuilder: (context, a, b) => Detaillogam(
                              periodikUnsur: unsur[index],
                            ),
                          ),
                        );
                      },
                      child: Stack(
                        children: <Widget>[
                          ...
                          Hero(
                            tag: unsur[index].position,
                            child: Image.asset(unsur[index].iconImage),
                          ),
                          Positioned(
                            right: 24,
                            bottom: 60,
                            child: Text(
                              unsur[index].position.toString(),
                              style: TextStyle(
                                fontFamily: 'Avenir',
                                fontSize: 200,
